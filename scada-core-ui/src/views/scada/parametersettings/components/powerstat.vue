<template>
    <div style="align-items: center">
      <CRow>
        <CCol sm="12" lg="12">
          <div class="card" style="background: #011240; height: 260px">
      ...
      <CRow>
        ...
        <CCol sm="6" lg="6">
          <CRow>
            <CCol>
              <div class="card" style="background: #011240; height: 117px">
                <div class="card-body" style="color: #9fdfdf">
                  <div class="small" style="height: 20px">发无功总量（万kwh）</div>
          ...
          <CRow>
            <CCol>
              <div class="card" style="background: #011240; height: 117px">
                <div class="card-body" style="color: #9fdfdf">
                  <div class="small" style="height: 20px">收无功总量（万kwh）</div>
